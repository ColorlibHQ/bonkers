/* global bonkers_ScreenReaderText */
/**
...
(function( $ ) {
	...
	function initMainNavigation( container ) {
		...
		var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
			...
			.append( $( '<span />', { 'class': 'screen-reader-text', text: bonkers_ScreenReaderText.expand }) );
		...
		container.find( '.current-menu-ancestor > button' )
			...
			.text( bonkers_ScreenReaderText.collapse );
		...
		container.find( '.dropdown-toggle' ).click( function( e ) {
			...
			screenReaderSpan.text( screenReaderSpan.text() === bonkers_ScreenReaderText.expand ? bonkers_ScreenReaderText.collapse : bonkers_ScreenReaderText.expand );
		});
	}
		...
		function toggleFocusClassTouchScreen() {
			if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
				...
				siteNavigation.find( '.menu-item-has-children > a, .page_item_has_children > a' )
					.on( 'touchstart.bonkers', function( e ) {
