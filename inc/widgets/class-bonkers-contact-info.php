...
class Bonkers_Contact_Info extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_attr__( 'Bonkers - Contact Info', 'bonkers' ), // Name
			array(
				'description' => esc_attr__( 'Display contact info.', 'bonkers' ),
...
?>
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'address' ) ); ?>"><?php esc_html_e( 'Address', 'bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Email', 'bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>"><?php esc_html_e( 'Phone', 'bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'website' ) ); ?>"><?php esc_html_e( 'Website', 'bonkers' ); ?></label><br />
