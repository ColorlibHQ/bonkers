...
class Bonkers_Team_Member extends WP_Widget {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'bonkers-addon-widgets-script', get_template_directory_uri() . '/assets/js/widget-media.js', array( 'jquery' ), wp_get_theme()->get( 'Version' ), true );
...
?>
	...
	public function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'image_uri' ) ); ?>"><?php esc_html_e( 'Image', 'bonkers' ); ?> <small><?php esc_html_e( 'Use square images (1:1)', 'bonkers' ); ?></small></label><br/>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Name', 'bonkers' ); ?></label><br/>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'position' ) ); ?>"><?php esc_html_e( 'Position', 'bonkers' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_snapchat' ) ); ?>"><?php esc_html_e( 'Snapchat URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_google_plus' ) ); ?>"><?php esc_html_e( 'Google Plus URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_github' ) ); ?>"><?php esc_html_e( 'Github URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_wordpress' ) ); ?>"><?php esc_html_e( 'WordPress URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_youtube' ) ); ?>"><?php esc_html_e( 'YouTube URL','bonkers' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_vimeo' ) ); ?>"><?php esc_html_e( 'Vimeo URL','bonkers' ); ?></label><br />
