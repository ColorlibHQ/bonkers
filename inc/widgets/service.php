...
add_action( 'admin_enqueue_scripts', 'bonkers_service_widget_scripts' );

function bonkers_service_widget_scripts(){

    wp_enqueue_media();

    wp_enqueue_script( 'bonkers_service_widget_script', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );
