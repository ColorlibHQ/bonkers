...
?>
	...
	public function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'image_uri' ) ); ?>"><?php esc_html_e( 'Image', 'bonkers' ); ?></label><br/>
		...
		<p>
			...
			<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'icon' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'icon' ) ); ?>" value="<?php echo esc_attr( isset( $instance['icon'] ) ? $instance['icon'] : '' ); ?>" placeholder="fa fa-mobile" />
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'bonkers' ); ?></label><br/>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Text', 'bonkers' ); ?></label><br/>
