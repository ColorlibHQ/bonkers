...
<div id="bonkers-welcome-section" class="bonkers-welcome-section" <?php if ( false == $bonkers_enable_section ) : echo 'style="display: none;"';
else : echo 'style="background-image: url(' . esc_url( $bonkers_welcome_image ) . ')"'; endif ?>>
