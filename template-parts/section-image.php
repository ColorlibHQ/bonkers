...
?>
<div id="bonkers-image-section" class="bonkers-image-section <?php echo esc_attr( $bonkers_image_css_class ); ?>" <?php if ( false == $bonkers_enable_section ) : echo 'style="display: none;"';
endif; ?>>

	<?php
	$bonkers_image_image = get_option( 'bonkers_addons_image_image', esc_url( get_template_directory_uri() ) . '/images/StockSnap_JBW2PXDOL6.jpg' );
